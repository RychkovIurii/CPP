...
/*   Updated: 2025/04/09 14:24:55 by irychkov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	basic_test( void )
{
	...
	std::cout << "\t\tWe execute: FragTrap joe('Joe');"
		<< std::endl << std::endl;
	FragTrap joe("Joe");
	std::cout << std::endl;

	std::cout << "\t\tWe execute: FragTrap leo('Leo');"
		<< std::endl << std::endl;
	FragTrap leo("Leo");
	std::cout << std::endl;
	...
	std::cout << "\t\tWe execute: FragTrap pekka(joe);"
		<< std::endl << std::endl;
	FragTrap pekka(joe);
	std::cout << std::endl;
